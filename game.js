...
//21.1You'll need a way to keep track of whether if the game has started or not, so you only call nextSequence() on the first keypress.
var started = false;
...
function nextSequence() {
    ...
    /*4. Create a new variable called randomChosenColour and use the randomNumber from step 2 to select a random colour 
    from the buttonColours array. */
...
function animatePress(currentColor) {
    ...
    /*19. Take a look inside the styles.css file, you can see there is a class called "pressed", 
